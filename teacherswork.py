...
# 2/4 *100 процент числа
# померить скорость каждой сортировки
# сделать функцию которая будет считать корни квадратного уравнения
# можно связать с задачей которая считатет дискриминант
#
# написать функцию которая строит график этого квадратного уравнения
